...
(rate_line,) = ax2.plot(x, y2, label="TGZ 1 Gasdurchflussrate", color="#CC071E", linestyle="--") #CC071E is the RWTH red (both colors as defined in the official RWTH guide)
ax2.set_ylabel("TGZ 1 Gasdurchflussrate in L/min", color="#CC071E")
...
try:
    while True:
        ...
        plt.title("TGZ 1 Gasvolumen: " + str(gas_volume) + "L", fontsize=25)#Diagrammtitel
