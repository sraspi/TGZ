...
(vol_line,) = ax.plot(x, y, label="TGZ C Gasvolumen", color="#00549F") #00549F is the RWTH blue color
...
plt.title("TGZ C Gasvolumen: " + str(gas_volume) + "L", fontsize=25) # To display 0ml initially. Will be updated in an event-driven manner (see on_trigger)
...
try:
    while True:
        ...
        plt.title("TGZ C CO2-Volumen: " + str(gas_volume) + " L  " , fontsize=25)#Diagrammtitel
