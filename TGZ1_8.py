...
data = "/home/pi/stta/" + "TGZ_2_" + timestr+ ".txt"
f = open(data,  "w")
...
fig.canvas.manager.set_window_title("TGZ 2")
...
ax.set_ylabel("TGZ 2 Gasvolumen in L", color="#00549F")
...
ax2.set_ylabel("TGZ 2 Gasdurchflussrate in L/min", color="#CC071E")
# plt.ylim(0, 150) commented out because it overrides dynamic axes scaling
plt.title("TGZ 2 Gasvolumen: " + str(gas_volume) + "L", fontsize=25) # To display 0ml initially. Will be updated in an event-driven manner (see on_trigger)
...
try:
    while True:
        ...
        plt.title("TGZ 2 Gasvolumen: " + str(gas_volume) + "L", fontsize=25)#Diagrammtitel
